...
TERM_STARTS = {
    ...
    (2026, 1): date(2026, 1, 11),
    (2026, 2): date(2026, 4, 19),

    (2026, 3): date(2026, 10, 4),
    (2027, 1): date(2027, 1, 10),
    (2027, 2): date(2027, 4, 18),

    (2027, 3): date(2027, 10, 4),
    (2028, 1): date(2028, 1, 9),
    (2028, 2): date(2028, 4, 16),

    (2028, 3): date(2028, 10, 1),
    (2029, 1): date(2029, 1, 7),
    (2029, 2): date(2029, 4, 15),

    (2029, 3): date(2029, 9, 30),
    (2030, 1): date(2030, 1, 6),
    (2030, 2): date(2030, 4, 21),

    (2030, 3): date(2030, 10, 6),
    (2031, 1): date(2031, 1, 12),
    (2031, 2): date(2031, 4, 20),
}
